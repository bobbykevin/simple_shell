 ...
 * @cmd_buf_type: CMD_type, one of CMD_NORM, CMD_OR, CMD_AND, CMD_CHAIN
 * @readfd: the file descriptor from which to read line input
 * @histcount: the history line number count
 *
 * This structure defines a set of pseudo-arguments that can be
 * passed into a function. It is used to provide a uniform prototype
 * for a function pointer struct.
 */
